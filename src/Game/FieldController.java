...
public class FieldController {
    ...
    public static GUI_Street[] myGuiFields = {
            ...
            new GUI_Street("4", "PALACE GATES", "Hvad gemmer sig mon bag paladsets porte?", "100 kr", Color.GRAY, Color.PINK),
            ...
            new GUI_Street("10", "THE WEREWALL", "Vogt dig.. ikke for sarte sjæle", "-80 kr", Color.GRAY, Color.YELLOW),
            new GUI_Street("11", "THE PIT", "Take Care, man skulle jo nødig, tabe noget", "-50 kr", Color.RED, Color.BLUE),
