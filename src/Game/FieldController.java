...
public class FieldController {
    ...
    final Field[] fields = {
            new Start(FieldPropertyNames.instanceOf().number(1),0, fm.number(0)),
            new Property(FieldPropertyNames.instanceOf().number(2), 1, 1, fm.number(1), "brown"),
            new Property(FieldPropertyNames.instanceOf().number(3), 2, 1, fm.number(2), "brown"),
            new ChanceCard(FieldPropertyNames.instanceOf().number(4), 3, fm.number(3)),
            new Property(FieldPropertyNames.instanceOf().number(5), 4, 1, fm.number(4), "lightBlue"),
            new Property(FieldPropertyNames.instanceOf().number(6), 5, 1, fm.number(5), "lightBlue"),
            new JailVisit(FieldPropertyNames.instanceOf().number(7), 6, fm.number(6)),
            new Property(FieldPropertyNames.instanceOf().number(8), 7, 2, fm.number(7), "pink"),
            new Property(FieldPropertyNames.instanceOf().number(9), 8, 2, fm.number(8), "pink"),
            new ChanceCard(FieldPropertyNames.instanceOf().number(10), 9, fm.number(9)),
            new Property(FieldPropertyNames.instanceOf().number(11), 10, 2, fm.number(10), "gold"),
            new Property(FieldPropertyNames.instanceOf().number(12), 11, 2, fm.number(11), "gold"),
            new Parking(FieldPropertyNames.instanceOf().number(13), 12, fm.number(12)),
            new Property(FieldPropertyNames.instanceOf().number(14), 13, 3, fm.number(13), "red"),
            new Property(FieldPropertyNames.instanceOf().number(15), 14, 3, fm.number(14), "red"),
            new ChanceCard(FieldPropertyNames.instanceOf().number(16), 15, fm.number(15)),
            new Property(FieldPropertyNames.instanceOf().number(17), 16, 3, fm.number(16), "yellow"),
            new Property(FieldPropertyNames.instanceOf().number(18), 17, 3, fm.number(17), "yellow"),
            new Jail(FieldPropertyNames.instanceOf().number(19), 18, fm.number(18)),
            new Property(FieldPropertyNames.instanceOf().number(20), 19, 4, fm.number(19), "green"),
            new Property(FieldPropertyNames.instanceOf().number(21), 20, 4, fm.number(20), "green"),
            new ChanceCard(FieldPropertyNames.instanceOf().number(22), 21, fm.number(21)),
            new Property(FieldPropertyNames.instanceOf().number(23), 22, 5, fm.number(22), "blue"),
            new Property(FieldPropertyNames.instanceOf().number(24), 23, 5, fm.number(23), "blue")
    };
